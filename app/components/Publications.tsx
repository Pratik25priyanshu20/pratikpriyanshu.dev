    ...
    <section id="publications" className="py-section" aria-label="Publications">
      <div className="section-container">
        ...
        >
          ...
          >
            Pub<span className="gradient-text">lications</span>
          </motion.h2>
            ...
            {publications.map((pub, index) => (
              ...
              >
                ...
                <div className="pl-4">
                  ...
                  {/* Title */}
                  <h3 className="text-text-primary font-heading font-semibold text-lg mb-2 leading-snug">
                    {pub.title}
                  </h3>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {pub.links.map((link) => (
                      ...
                      >
                        {link.label === "Paper" || link.label === "arXiv" ? (
                          <svg
                            width="16"
                            height="16"
                            viewBox="0 0 24 24"
